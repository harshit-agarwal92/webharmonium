...
import { Flame, Star, Compass, Search, FolderHeart, Download, Home } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full bg-[#050505] text-white flex overflow-hidden font-sans">
      ...
      <main className="flex-1 h-screen overflow-y-auto custom-scrollbar relative z-10">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#8B5CF6]/10 blur-[150px] pointer-events-none rounded-full" />
        <div className="absolute top-[40%] left-0 w-[400px] h-[400px] bg-[#EC4899]/10 blur-[150px] pointer-events-none rounded-full" />
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'explore' && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-32 text-center max-w-lg mx-auto">
                <Compass className="w-20 h-20 text-[#EC4899] mb-6 animate-pulse" />
                ...
                <button 
                  ...
                  className="px-8 py-3.5 bg-gradient-to-r from-[#EC4899] to-[#8B5CF6] rounded-full text-sm font-black uppercase tracking-wider text-white shadow-[0_0_30px_rgba(236,72,153,0.4)] hover:shadow-[0_0_40px_rgba(236,72,153,0.6)] hover:scale-105 active:scale-95 transition-all"
                >
                  Go Back to Home
                </button>
              </motion.div>
            ...
            {['favorites', 'library', 'downloads'].includes(activeTab) && (
